...
///
/// 派生した場合、必ず派生元は、最後の一つを除いた番号になる。(0)2_1_0_0であれば、管理番号を戻して、最後の一つを削除し、
/// 0_1_0ということになる。必ず派生元はわかる。
///
/// 最終Phaseから派生する場合、Phase Shiftが発生する可能性があり、その際には祖先フェーズやソースから派生することになる・・・
/// あまりいいことじゃないような気がするんだよなあ・・・でも他にどうすればいいのか・・・
///
/// 最新管理番号をgetする方法であるが、最新のファイルは必ず最新の管理番号になる、つまり子フェーズがないファイルから派生する場合でも、
/// それが細心でないならば管理番号を新しくつけ直す。
///
