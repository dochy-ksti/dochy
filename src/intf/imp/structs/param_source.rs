use crate::core::structs::{VarType, ParamType};
use crate::intf::imp::structs::source_builder::SourceBuilder;
use crate::intf::imp::util::to_type_name::to_snake_name;
use crate::intf::imp::util::with_old::with_old;
use crate::intf::imp::util::with_var::with_var;
use crate::intf::imp::util::into_qv::into_qv;
