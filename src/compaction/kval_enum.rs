...
impl Decimal{
    ...
    pub fn to_f64(&self) -> f64 {
        crate::compaction::enc_dec::decimal_lib::to_f64(self.int, self.dot)
    }
    /// get the edecimal string
    pub fn to_string(&self) -> String{
        crate::compaction::enc_dec::decimal_lib::to_string(self.int, self.dot)
    }
    /// create the value
...
impl KVal {
    ...
    pub fn to_string(&self) -> String{
        crate::compaction::string_compaction::to_string(self)
    }
}