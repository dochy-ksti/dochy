...
use crate::compaction::enc_dec::kihon_from_tag::KihonFromTag;
use anyhow::Result;
use std::io::Read;
use crate::compaction::enc_dec::reader::Reader;
    ...
    for tag in tags{
        let kihon = match tag{
            ...
            KihonFromTag::Decimal(size) =>{
                ...
                KVal::Decimal(crate::compaction::kval_enum::Decimal::new(v, dot))
            },
