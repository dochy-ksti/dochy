...
//         map3 : HashMap<String, u64>,
//         map4 : HashMap<String, u64>,
//         map5 : HashMap<String, u64>,
//         map6 : HashMap<String, u64>,
//         map7 : HashMap<String, u64>,
//         map8 : HashMap<String, u64>,
//         map9 : HashMap<String, u64>,
//         map10 : HashMap<String, u64>,
//         map11 : HashMap<String, u64>,
//         map12 : HashMap<String, u64>,
//     }
//
//     impl VeryBig{
//         pub fn new() -> VeryBig{
...
//
//     #[bench]
//     fn bench_init_hash_set(b: &mut Bencher) {
//         let (_rng, names) = init1();
//
//         b.iter(|| {
