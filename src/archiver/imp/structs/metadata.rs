...
use crate::compaction::basic_compaction::{comp_str, comp_int};
use crate::archiver::imp::calc_hash::calc_hash;

use crate::compaction::{decode};
use crate::archiver::ArcResult;
use crate::archiver::imp::structs::metadata_item::MetadataItem;
use crate::archiver::imp::structs::file_item::FileItem;
use std::io::Read;
...
impl Metadata{
    ...
    pub(crate) fn to_bytes(&self) -> ArcResult<Vec<u8>>{
        ...
        return Ok(crate::compaction::encode_to_vec(&r)?);
    }
