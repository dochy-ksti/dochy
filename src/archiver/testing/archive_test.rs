use crate::archiver::{ArcResult, ArchiveOptions};
use crate::archiver::imp::create_archive_from_directory::CreateArchiveFromDirectory;
use anyhow::anyhow;
...
fn archive_test() -> ArcResult<()>{
    ...
    crate::archiver::imp::create_archive_from_directory::create_archive_from_directory(
        ...
        let archive_data = crate::archiver::read_archive_data(&mut buf.as_slice())?;
