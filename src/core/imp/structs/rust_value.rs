...
use crate::core::imp::structs::rust_list::{ConstTable, ConstList, MutList, ConstInnerList, MutInnerList};
...
impl RustValue{
    ...
    pub(crate) fn into_root_value2(self, name : &str) -> crate::core::error::CoreResult<RootValue>{
