use dochy_core::structs::{VarType, ParamType};
...
impl ParamSource{
    ...
    pub fn get_mutable(&self, mod_name : &str) -> String{
        ...
        sb.push(0,&format!("pub fn {}_mutable(&self) -> {}{{", with_old(&snake_name, is_old), with_var(&format!("&mut {}", pt.typename()), var_type)));
    ...
    pub fn get_def(&self, mod_name : &str) -> String{
        ...
        sb.push(0,&format!("pub fn {}_def_val(&self) -> {}{{", with_old(&snake_name, is_old), with_var(&format!("&mut {}", pt.typename()), var_type)));
